...
item(2, 'Conjunto Velas N60', 'Bosch', 'Velas', 5.00, 7.99, 10).
...
item(13, 'Conjunto Velas N35', 'Bosch', 'Velas', 3.50, 4.99, 20).
...
servico(14, 'Serviço de Reboque', ['Servicos'], 1, 1.0, 120.00).
servico(15, 'Lavagem de Motor', ['Servicos'], 1, 1.0, 50.00).
servico(16, 'Revisao Geral', ['Oleos', 'Filtros Oleo', 'Velas', 'Pastilhas Travoes', 'Filtros Ar', 'Anticongelantes'], 2, 4.00, 0.00).
desconto_marca('Michelin', 0.1).
desconto_marca('Bosch', 0.15).
desconto_marca('Philips', 0.3).
desconto_mao_obra(Tempo, 0.05) :- Tempo < 0.25.
desconto_mao_obra(Tempo, 0.15) :- Tempo > 4.
